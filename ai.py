...
y_combined_train = {'up_trend': y_up_train, 'down_trend': y_down_train}
model.fit(X_train, y_combined_train, epochs=runs, batch_size=32)
...
# up_probabilities = predictions[:, 0]  # Wahrscheinlichkeit für Aufwärtstrend
# down_probabilities = predictions[:, 1]  # Wahrscheinlichkeit für Abwärtstrend

# # Beispielausgabe
# for i in range(1):
#     print(f"Aufwärtstrend Wahrscheinlichkeit: {up_probabilities[i]:.2f}, Abwärtstrend Wahrscheinlichkeit: {down_probabilities[i]:.2f}")
