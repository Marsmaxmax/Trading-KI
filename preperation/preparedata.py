...
# CSV-Datei laden
input_file = 'data/NASDAQ100_5m/NQ_5Years_8_11_2024.csv'  # Name der Eingabedatei
output_file = 'data/NASDAQ100_5m/output.csv'  # Name der Ausgabedatei
...
data[[1, 4, 2, 3]].to_csv(output_file, header=False, index=False)
