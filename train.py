...
training_set_1 = 'data/train_1.csv'
training_set_2 = 'data/train_2.csv'
training_set_3 = 'data/train_3.csv'
training_set_4 = 'data/train_4.csv'
...
candles = data.values
x_close, x_open, x_high, x_low, x_ema1, x_ema2, x_ema3, y = create_sequences(candles, 64)

model = load_custom_model(model_file)
x = [x_close, x_open, x_high, x_low, x_ema1, x_ema2, x_ema3]
if runs < 50 :
    history = model.fit(x, y, epochs = runs, batch_size=batch, validation_split=0.1)
else:
